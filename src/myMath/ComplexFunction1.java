...
import myMath.ComplexFunction.Node;


public class ComplexFunction1 implements complex_function {
	...
	public ComplexFunction1() {
		
		complexFunc = new Node();		
	}
	
	public ComplexFunction1(String s) {
	...
	public function initFromString(String s) {
		...
		ComplexFunction1 comFunc = new ComplexFunction1(s);
